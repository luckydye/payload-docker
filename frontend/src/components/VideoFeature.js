...
export default class VideoFeature extends LitElement {
        ...
        return html`
            ...
            <section>
                <div class="content-wrapper">
                    ${this.data ? html`
                        <video loop autoplay muted class="feature" src="${this.data.asset.url}"></video>
                        <div class="caption">
...
customElements.define('video-feature', VideoFeature);
